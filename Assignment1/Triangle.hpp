...
public:
	...
	void setVertex(int ind, const Eigen::Vector3f &ver); /*set i-th vertex coordinates */
	void setNormal(int ind, const Eigen::Vector3f &n);   /*set i-th vertex normal vector*/
